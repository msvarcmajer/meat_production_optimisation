...
x = LpVariable("Kvalitetna_Salama", lowBound=0)
...
U = 0.2  # Minimalni udio kvalitetne salame (raspon 0-1)

Cijena_govedine = 5
Cijena_svinjetine = 3
Marza = 1 #Raspon marze je 0-1

Prodajna_cijena_kvalitetne_salame = (0.8*Cijena_govedine + 0.2*Cijena_svinjetine)+(0.8*Cijena_govedine + 0.2*Cijena_svinjetine)*Marza
...
Profit= (Prodajna_cijena_kvalitetne_salame * x + Prodajna_cijena_normalne_salame * y + Prodajna_cijena_jeftine_salame * z) - (S*Cijena_svinjetine + G*Cijena_govedine)
...
prob += x >= 0, "Nenegativna količina kvalitetne salame"
...
if prob.status == LpStatusOptimal:
    print("Količina kvalitetne salame:", x.value())
